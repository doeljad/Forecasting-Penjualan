...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <!-- <li class="nav-item <?php echo ($page == 'data-suplier') ? 'active' : ''; ?>">
            <a class="nav-link" href="?page=data-suplier">
        ...
        <li class="nav-item nav-category">Prediksi</li>
        <li class="nav-item <?php echo ($page == 'forecast') ? 'active' : ''; ?>">
            <a class="nav-link" href="?page=forecast">
